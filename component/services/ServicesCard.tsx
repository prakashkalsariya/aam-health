...
function Servicescard() {
  return (
    <div className={styles.services_card_main_container}>
      <div
        className={`${styles.primary_care_container} ${styles.service_container}`}
      >
      ...
      <div
        className={`${styles.urgent_care_container} ${styles.service_container}`}
      >
        <div className={styles.contain_container}>
          <h1>Urgent Care</h1>
      ...
      <div
        className={`${styles.mental_health_container} ${styles.service_container}`}
      >
        <div className={styles.contain_container}>
          <h1>Mental Health</h1>
      ...
      <div
        className={`${styles.women_health_container} ${styles.service_container}`}
      >
        <div className={styles.contain_container}>
      ...
      <div
        className={`${styles.lgbtq_health_container} ${styles.service_container}`}
      >
        <div className={styles.contain_container}>
          <h1>LGBTQ + Health</h1>
